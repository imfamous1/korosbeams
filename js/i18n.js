...
(function () {
  ...
  var STRINGS = {
    ru: {
      ...
      "meta.title.jobs": "Вакансии в деревообрабатывающем производстве | ООО «КОРОС»",
      ...
      "meta.desc.jobs": "Актуальные вакансии ООО «КОРОС» в Санкт-Петербурге и на производстве в п. Тихорицы: продажи, управление цехом, смена и рабочие специальности.",
      ...
      "widget.chat.toggleLabel": "Написать",
      ...
      "index.hero.lead": "БДК Н20 КОРОС для опалубки перекрытий в монолитном строительстве: двутавровые балки БДК Н20 «КОРОС». Собственное производство. Полный цикл, строгий контроль качества. Доставка по Санкт-Петербургу, Ленинградской области и РФ.",
      "index.hero.trust1": "Стандарты: ГОСТ Р 71938-2025 и EN 13377:2002",
      "index.hero.trust2": "Материалы: фанера ФСФ, хвойные пиломатериалы, PUR-клей, полимерная заглушка, защитный ЛКМ-состав.",
      ...
      "index.hero.img.alt": "Лесопилка и склад жёлтых балок БДК",

      "index.features.title": "От сырья до поставки клиенту — всё под нашим контролем.",
      "index.features.lead": "Наши ценности:",
      "index.features.value1": "Полный цикл производства",
      "index.features.value2": "Материалы и качественные компоненты",
      "index.features.value3": "Соответствие российским и международным стандартам",
      "index.features.value4": "Внутренняя и международная логистика",
      ...
      "index.feat1.img.alt": "Схема этапов первого этапа производства",
      "index.feat1.text":
        "Распиловка — камерная сушка — оптимизация и сращивание заготовок — строжка заготовок (стенка, полка) — склейка, прессование — покраска, маркировка — хранение. Все этапы под нашим контролем.",
      ...
      "index.feat3.text": "Пиломатериалы не ниже II сорта по ГОСТ. Фанера ФСФ по ГОСТ 3916.1-2018 и EN 636-3. Соединение PUR-клеем по EN 301 / EN 204-205. Защитное ЛКМ-покрытие. Полимерные заглушки на торцах.",
      "index.feat3.li1": "Пиломатериалы не ниже II сорта по ГОСТ.",
      "index.feat3.li2": "Фанера ФСФ по ГОСТ 3916.1-2018 и EN 636-3.",
      "index.feat3.li3": "Соединение PUR-клеем по EN 301 / EN 204-205.",
      "index.feat3.li4": "Защитное ЛКМ-покрытие.",
      "index.feat3.li5": "Полимерные заглушки на торцах.",
      "index.product.kicker": "Балка",
      "index.product.img.alt": "Балка БДК в разрезе",
      "index.product.titleLine1": "Наша продукция:",
      "index.product.s1.title": "<a class=\"text-primary hover:text-primary/80 underline decoration-primary/30 underline-offset-4 transition-colors\" href=\"/catalog/#h20\">Балка БДК Н20</a> и <a class=\"text-primary hover:text-primary/80 underline decoration-primary/30 underline-offset-4 transition-colors\" href=\"/catalog/#h20-pro\">Балка БДК Н20 Про</a>",
      "index.product.s1.text": "Обе линейки — высота 200 мм, полка 40×80 мм, влажность древесины 12 ± 2 %, масса около 5,2 кг на погонный метр.",
      "index.product.s2.title": "Защита и покрытие",
      "index.product.s2.text": "В стандартном исполнении торцы обрабатываются защитным ЛКМ. В линейке Про торцы закрываются полимерными заглушками. Вся поверхность балки покрывается защитным ЛКМ-составом жёлтого цвета.",
      ...
      "index.partners.title": "Поставки по Санкт-Петербургу, Ленинградской области, РФ и за рубежом",
      "index.partners.text": "Грузия, Турция, Египет, ОАЭ, Израиль, Китай и другие страны — опыт поставок и сотрудничества с российскими и международными компаниями.",
      ...
      "index.specs.lengths.standard": "Стандартные: 2,45/<wbr>2,65/<wbr>2,90/<wbr>3,30/<wbr>3,60/<wbr>3,90/<wbr>4,50/<wbr>4,90/<wbr>5,90 метров",
      ...
      "mfg.hero.lead": "Собственная сырьевая база, полный производственный цикл и контроль всех этапов.",
      ...
      "mfg.about.photo.caption": "Производство ООО «КОРОС» в п. Тихорицы, Ленинградская область",
      ...
      "mfg.cycle.02.d": "Технологии сращивания и формирование шипового соединения согласно EN.",
      "mfg.cycle.03.t": "Склейка БДК",
      "mfg.cycle.03.d": "Склейка и прессование двутавра PUR-клеем по EN 301 / EN 204-205.",
      ...
      "cat.hero.item2": "Базовая БДК Н20 подходит для типовых опалубочных решений; H20 Pro — для объектов, где нужна усиленная защита торцов и фанера до 27 мм.",
      "cat.hero.item3": "Доставка по Санкт-Петербургу и Ленинградской области.",
      ...
      "cat.apps.title": "Где используют балки H20 в монолитном строительстве",
      "cat.apps.lead": "Опалубочные балки H20 применяют в системах для бетонирования перекрытий, стен, колонн и инфраструктурных элементов. Подберем длину и комплектацию под проект в СПб, Ленинградской области и других регионах.",
      "cat.apps.ph.aria": "Место для фотографии: пример применения",
      "cat.apps.ph.caption": "Фото",
      "cat.apps.1.img.alt": "Применение балок БДК Н20: перекрытия",
      "cat.apps.1.t": "Перекрытия",
      "cat.apps.1.p": "Опалубочные системы для монолитных плит жилых, офисных и общественных зданий.",
      "cat.apps.2.img.alt": "Применение балок БДК Н20: стены и жёсткие ядра",
      "cat.apps.2.t": "Стены и жёсткие ядра",
      "cat.apps.2.p": "Вертикальная опалубка стен, лифтовых шахт и несущих ядер высотных корпусов.",
      "cat.apps.3.img.alt": "Применение балок БДК Н20: инфраструктурные объекты",
      "cat.apps.3.t": "Колонны и пилоны",
      "cat.apps.3.p": "Опалубка колонн и пилонов в жилых, коммерческих и инфраструктурных проектах.",

      "cat.info.title": "Применение, монтаж и стандарты H20",
      "cat.info.lead": "Для инженеров ПТО и снабжения подготовлены базовые направления контента: применение балок H20 в строительстве, монтаж и демонтаж опалубки, сравнение с аналогами, сертификация и стандарты качества.",
      "cat.info.app.t": "Применение",
      "cat.info.app.p": "Перекрытия, стены, ядра, инфраструктура.",
      "cat.info.quality.t": "Монтаж и качество",
      "cat.info.quality.p": "Контроль партии и работа с документацией.",
      "cat.info.compare.t": "Сравнение",
      "cat.info.compare.p": "H20 и H20 Pro по защите торцов.",
      "cat.info.cert.t": "Сертификация",
      "cat.info.cert.p": "ГОСТ, EN, протоколы испытаний.",
      "cat.filter.title": "Подбор балки H20",
      "cat.filter.length": "Длина",
      "cat.filter.height": "Высота",
      "cat.filter.build": "Исполнение",
      "cat.seo.title": "Каталог опалубочных балок",
      "cat.seo.text": "В каталоге представлены деревянные двутавровые балки H20 для монолитной опалубки. Подберем длину под перекрытие, несущую схему и логистику объекта, подготовим коммерческое предложение для закупки или аренды строительного оборудования.",
      "cat.seo.tag.formwork": "опалубка",
      "cat.seo.tag.concrete": "бетон",
      "cat.seo.tag.slab": "перекрытие",
      "cat.seo.tag.capacity": "несущая способность",
      "cat.seo.tag.assembly": "монтаж",
      ...
      "prod.norm.hero.h1.product": "Балка двутавровая H20 Classic 3,6 м",
      ...
      "prod.gallery.prev": "Предыдущее фото",
      "prod.gallery.next": "Следующее фото",
      "prod.gallery.thumbs": "Фото товара",
      "prod.gallery.photo1": "Фото 1",
      "prod.gallery.photo2": "Фото 2",
      ...
      "prod.norm.hero.lead": "Стандартное исполнение БДК Н20: фанера ФСФ 24 мм и обработка торцов защитным составом. Популярная длина 3,0 м и другие типоразмеры подходят для опалубки перекрытий, стен и колонн в монолитном строительстве.",
      "prod.norm.badge": "H20",
      ...
      "prod.norm.info.title": "Балка H20 Classic 3,6 м для опалубки",
      "prod.norm.info.lead": "Популярная длина 3,6 м подходит для типовых схем опалубки перекрытий, стен и колонн. Актуальную цену балки H20 в СПб рассчитываем по объему, комплектации, упаковке и адресу доставки.",
      "prod.norm.info.materials.t": "Материалы и производство",
      "prod.norm.info.materials.p": "Пояса из хвойной древесины, стенка из влагостойкой фанеры ФСФ, склейка PUR-клеем, покраска, маркировка и контроль влажности. Производство расположено в Ленинградской области.",
      "prod.norm.info.benefits.t": "Преимущества",
      "prod.norm.info.benefits.p": "Двутавровое сечение снижает массу при сохранении несущей способности. Балку удобно применять в инвентарной опалубке, хранить в пакетах и учитывать по погонным метрам.",
      "prod.norm.info.docs.t": "Документация",
      "prod.norm.info.docs.p": "По запросу предоставляем презентацию, паспорт партии, протоколы испытаний и сведения о соответствии ГОСТ Р 71938-2025 и EN 13377:2002.",
      "prod.norm.info.docs.link": "Сертификаты и файлы",
      "prod.norm.info.delivery.t": "Доставка и оплата",
      "prod.norm.info.delivery.p": "Отгрузка в Санкт-Петербург и районы Ленинградской области: Всеволожский, Гатчинский, Кировский, Тосненский, Ломоносовский и другие направления. Условия оплаты фиксируются в счете и договоре.",
      ...
      "prod.norm.table.length.v": "1,5–6",
      ...
      "contact.addr.officeSpb.title": "Офис",
      ...
      "contact.addr.plant.line2": "п. Тихорицы, ул. Набережная, д. 1Н, помещ. 2А",
      "contact.addr.officePhone": "Телефон офиса:",
      "contact.addr.plantPhone": "Телефон производства:",
      ...
      "contact.direct.title": "Связь и реквизиты",
      ...
      "contact.legal.shortNameValue": "ООО «КОРОС»",
      "contact.legal.inn": "ИНН",
      "contact.legal.kpp": "КПП",
      ...
      "cert.card2.link": "Посмотреть",
      "cert.card2.visual": "Паспорт + ТУ",
      "cert.card2.badge": "Можно посмотреть",
      "cert.card2.img.alt": "Превью паспорта продукции и технических условий БДК Н20",
      ...
      "cert.card3.img.alt": "Превью презентации БДК Н20",
      ...
      "cert.passportModal.title": "Паспорт продукции и ТУ",
      "cert.passportModal.img.alt": "Паспорт продукции и технические условия БДК Н20",
      "cert.passportModal.caption": "Это начало паспорта продукции. Для согласования запросите полный актуальный комплект документов.",
      "cert.passportModal.cta": "Запросить полный",
      "cert.video.title": "Испытания в реальном процессе",
      "cert.video.sub": "Видео показывает, как балку БДК проверяют под рабочей нагрузкой: фиксируют поведение элемента, контролируют прогиб и подтверждают пригодность для применения в опалубочных системах.",
      "cert.video.caption": "На видео проходит испытание балки БДК: образец нагружают в условиях, близких к реальной работе, чтобы оценить жесткость, устойчивость формы и запас несущей способности.",
      ...
      "404.lead": "Адрес мог измениться после обновления структуры сайта. Перейдите на главную или откройте каталог продукции.",
      "404.home": "На главную",
      "404.catalog": "Продукция",
    ...
    en: {
      ...
      "meta.title.jobs": "Jobs in timber manufacturing | Koros LLC",
      ...
      "meta.title.404": "404 | Page not found",
      ...
      "meta.desc.jobs": "Open roles at Koros LLC in Saint Petersburg and at the Tikhoritsy production site: sales, workshop management, shift work and production roles.",
      ...
      "widget.chat.toggleLabel": "Message",
      ...
      "index.hero.img.alt": "Sawmill and yellow BDK beam stock",

      "index.features.title": "From raw material to delivery to the client — everything under our control.",
      "index.features.lead": "Our values:",
      "index.features.value1": "Full-cycle production",
      "index.features.value2": "Materials and quality components",
      "index.features.value3": "Compliance with Russian and international standards",
      "index.features.value4": "Domestic and international logistics",
      ...
      "index.feat1.img.alt": "Production stage-one process diagram",
      "index.feat1.text":
        "Sawing — kiln drying — blank optimization and finger-jointing — blank planing (web, flange) — gluing and pressing — coating, marking — storage. Every stage is under our control.",
      ...
      "index.feat3.text": "Sawn timber not below II grade per GOST. FSF plywood per GOST 3916.1-2018 and EN 636-3. PUR bonding per EN 301 / EN 204-205. Protective coating. Polymer end caps.",
      "index.feat3.li1": "Sawn timber not below II grade per GOST.",
      "index.feat3.li2": "FSF plywood per GOST 3916.1-2018 and EN 636-3.",
      "index.feat3.li3": "PUR bonding per EN 301 / EN 204-205.",
      "index.feat3.li4": "Protective coating.",
      "index.feat3.li5": "Polymer end caps.",
      "index.product.kicker": "Beams",
      "index.product.img.alt": "BDK beam cross-section",
      "index.product.titleLine1": "Our products:",
      "index.product.s1.title": "<a class=\"text-primary hover:text-primary/80 underline decoration-primary/30 underline-offset-4 transition-colors\" href=\"/catalog/#h20\">H20 beam</a> and <a class=\"text-primary hover:text-primary/80 underline decoration-primary/30 underline-offset-4 transition-colors\" href=\"/catalog/#h20-pro\">H20 Pro beam</a>",
      "index.product.s1.text": "Both lines share 200 mm height, 40×80 mm flange, approx. 12 ± 2 % moisture and ~5.2 kg/m mass.",
      "index.product.s2.title": "Protection & coating",
      "index.product.s2.text": "In the standard version, beam ends are treated with protective paintwork. In the Pro line, the ends are closed with polymer caps. The full beam surface is coated with a yellow protective paintwork compound.",
      ...
      "index.partners.text": "Georgia, Turkey, Egypt, the UAE, Israel, China and other countries — delivery and partnership experience with Russian and international companies.",
      ...
      "index.specs.lengths.standard": "Standard: 2.45/<wbr>2.65/<wbr>2.90/<wbr>3.30/<wbr>3.60/<wbr>3.90/<wbr>4.50/<wbr>4.90/<wbr>5.90 m",
      ...
      "mfg.about.photo.caption": "Koros production site in Tikhoritsy, Leningrad region",
      ...
      "cat.hero.listAria": "Catalog highlights",
      "cat.hero.item1": "Catalog of timber I-joist H20 beams for monolithic formwork.",
      "cat.hero.item2": "Standard BDK H20 fits typical formwork layouts; H20 Pro is for projects that need reinforced end protection and plywood up to 27 mm.",
      "cat.hero.item3": "Delivery across Saint Petersburg and the Leningrad Region.",
      ...
      "cat.apps.1.img.alt": "H20 BDK beam application: floor slabs",
      "cat.apps.1.t": "Floor slabs",
      "cat.apps.1.p": "Formwork systems for cast-in-place slabs in residential, office and public buildings.",
      "cat.apps.2.img.alt": "H20 BDK beam application: walls and structural cores",
      ...
      "cat.apps.3.img.alt": "H20 BDK beam application: infrastructure projects",
      ...
      "cat.info.title": "Applications, assembly and H20 standards",
      "cat.info.lead": "For engineers and procurement teams, this section groups the core content directions: H20 beam applications in construction, formwork assembly and dismantling, comparison with alternatives, certification and quality standards.",
      "cat.info.app.t": "Applications",
      "cat.info.app.p": "Slabs, walls, cores, infrastructure.",
      "cat.info.quality.t": "Assembly & quality",
      "cat.info.quality.p": "Batch control and documentation workflow.",
      "cat.info.compare.t": "Comparison",
      "cat.info.compare.p": "H20 and H20 Pro by end protection.",
      "cat.info.cert.t": "Certification",
      "cat.info.cert.p": "GOST, EN, test reports.",
      "cat.filter.title": "H20 beam selection",
      "cat.filter.length": "Length",
      "cat.filter.height": "Height",
      "cat.filter.build": "Build",
      "cat.seo.title": "Formwork beam catalogue",
      "cat.seo.text": "The catalogue includes timber H20 I-beams for monolithic formwork. We select lengths for slab layouts, structural schemes and site logistics, and prepare commercial offers for procurement or rental equipment needs.",
      "cat.seo.tag.formwork": "formwork",
      "cat.seo.tag.concrete": "concrete",
      "cat.seo.tag.slab": "slab",
      "cat.seo.tag.capacity": "load capacity",
      "cat.seo.tag.assembly": "assembly",
      ...
      "prod.norm.hero.h1.product": "H20 Classic 3.6 m timber beam",
      "prod.norm.hero.h1.accent": "",
      ...
      "prod.gallery.prev": "Previous photo",
      "prod.gallery.next": "Next photo",
      "prod.gallery.thumbs": "Product photos",
      "prod.gallery.photo1": "Photo 1",
      "prod.gallery.photo2": "Photo 2",
      ...
      "prod.norm.info.title": "H20 Classic 3.6 m formwork beam",
      "prod.norm.info.lead": "The popular 3.6 m length fits typical slab, wall and column formwork layouts. Current H20 beam pricing in Saint Petersburg is calculated by volume, build, packaging and delivery address.",
      "prod.norm.info.materials.t": "Materials & manufacturing",
      "prod.norm.info.materials.p": "Softwood flanges, moisture-resistant FSF plywood web, PUR bonding, coating, marking and moisture control. Production is located in the Leningrad Region.",
      "prod.norm.info.benefits.t": "Advantages",
      "prod.norm.info.benefits.p": "The I-beam section reduces weight while preserving load-bearing capacity. The beam is convenient for reusable formwork, packaged storage and running-metre accounting.",
      "prod.norm.info.docs.t": "Documentation",
      "prod.norm.info.docs.p": "On request we provide the presentation, batch passport, test reports and GOST R 71938-2025 / EN 13377:2002 compliance information.",
      "prod.norm.info.docs.link": "Certificates & files",
      "prod.norm.info.delivery.t": "Delivery & payment",
      "prod.norm.info.delivery.p": "Shipments cover Saint Petersburg and Leningrad Region districts including Vsevolozhsky, Gatchinsky, Kirovsky, Tosnensky, Lomonosovsky and other routes. Payment terms are fixed in the invoice and contract.",
      ...
      "contact.addr.plant.line2": "Tikhoritsy, Naberezhnaya St. 1N, premises 2A",
      "contact.addr.officePhone": "Office phone:",
      "contact.addr.plantPhone": "Production phone:",
      ...
      "contact.direct.title": "Contacts and company details",
      ...
      "contact.legal.shortNameValue": "Koros LLC",
      "contact.legal.inn": "Taxpayer ID",
      "contact.legal.kpp": "Tax registration reason code",
      ...
      "cert.card2.link": "View",
      "cert.card2.visual": "Passport + TS",
      "cert.card2.badge": "Preview available",
      "cert.card2.img.alt": "H20 beam product passport and technical specifications preview",
      ...
      "cert.card3.img.alt": "H20 beam presentation preview",
      ...
      "cert.passportModal.title": "Product passport & technical specifications",
      "cert.passportModal.img.alt": "H20 beam product passport and technical specifications",
      "cert.passportModal.caption": "This is the beginning of the product passport. Request the current full document bundle for approval.",
      "cert.passportModal.cta": "Request full document",
      "cert.video.title": "Testing in real operation",
      "cert.video.sub": "The video shows how a BDK beam is checked under working load: its behavior is recorded, deflection is monitored, and suitability for formwork systems is confirmed.",
      "cert.video.caption": "The beam sample is loaded in conditions close to real use to assess stiffness, shape stability, and load-bearing reserve.",
      ...
      "404.lead": "The address may have changed after the site structure was updated. Go to the homepage or open the product catalogue.",
      "404.home": "Home",
      "404.catalog": "Products",
    },
  };
