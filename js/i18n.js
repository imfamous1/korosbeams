...
(function () {
  ...
  var STRINGS = {
    ru: {
      ...
      "cat.apps.note": "Окончательный подбор исполнения (БДК Н20 или БДК Н20 Про), шага и длины балок — по проекту и нагрузкам конкретной площадки.",
    ...
    en: {
      ...
      "cat.apps.note": "H20 vs H20 Pro build, spacing and beam length are always confirmed against your project loads and site rules.",
