...
(function () {
  ...
  var STRINGS = {
    ru: {
      ...
      "meta.title.product.norm": "БДК Н20 Norm | ООО «КОРОС»",
      ...
      "meta.desc.catalog": "БДК Н20 Norm и БДК Н20 Про — две линейки деревянных балок для опалубки от ООО «КОРОС».",
      "meta.desc.product.norm": "БДК Н20 Norm: фанера ФСФ 24 мм, торцы с защитным составом. Техданные и стандарты ГОСТ и EN.",
      ...
      "cat.hero.lead": "Выберите исполнение под ваш проект: экономичное или усиленное Про<br />с полимерными заглушками и фанерой до 27 мм.",
      "cat.card.norm.title": "БДК Н20",
      ...
      "cat.card.pro.title": "БДК Н20 Про",
      "cat.card.pro.sub": "Про",
      ...
      "cat.apps.note": "Окончательный подбор линейки Norm или Про, шага и длины балок — по проекту и нагрузкам конкретной площадки.",

      "breadcrumb.norm": "БДК Н20 Norm",
      ...
      "prod.norm.hero.title": "БДК Н20 Norm",
      ...
      "prod.norm.img.alt": "Деревянная балка БДК Н20 Norm для опалубки",
    ...
    en: {
      ...
      "cat.card.pro.title": "H20 Pro beam",
