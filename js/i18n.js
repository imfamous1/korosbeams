...
(function () {
  ...
  var STRINGS = {
    ru: {
      ...
      "cert.modal.caption": "Это превью протокола. Для тендера или поставки запросите актуальный комплект документов под вашу партию.",
    ...
    en: {
      ...
      "cert.modal.caption": "This is a report preview. For tenders or supply, request the current document bundle for your batch.",
