...
(function () {
  ...
  var STRINGS = {
    ru: {
      ...
      "index.features.title": "От сырья до отгрузки — под нашим контролем",
      ...
      "index.procurement.kicker": "Для стройки и закупок",
      "index.procurement.title": "Опалубочные балки H20 от производителя",
      "index.procurement.lead": "КОРОС производит и поставляет балки H20 для подрядчиков, застройщиков, арендных парков и отделов снабжения. Работаем с заявками под объект, тендерной документацией и регулярными поставками.",
      "index.procurement.benefits.title": "Преимущества",
      "index.procurement.benefits.1": "Двутавровая геометрия 200 мм для систем опалубки перекрытий, стен и колонн.",
      "index.procurement.benefits.2": "Контроль древесины, фанеры ФСФ, PUR-клея, влажности и маркировки партии.",
      "index.procurement.benefits.3": "Соответствие ГОСТ Р 71938-2025 и EN 13377:2002, документы по запросу.",
      "index.procurement.delivery.title": "География поставок",
      "index.procurement.delivery.text": "Отгружаем балки БДК Н20 со склада и производства в Ленинградской области. Организуем доставку в Санкт-Петербург, Всеволожский, Гатчинский, Кировский, Тосненский, Ломоносовский и другие районы ЛО.",
      "index.procurement.apps.title": "Сферы применения",
      "index.procurement.apps.text": "Балки H20 используют в монолитном строительстве для палуб перекрытий, стеновой опалубки, колонн, пилонов, лифтовых шахт и временных несущих систем. Для подбора длины, объема и комплектации передайте спецификацию или ведомость ПТО.",
      ...
      "prod.norm.hero.lead": "Базовое исполнение БДК Н20: фанера ФСФ 24 мм и обработка торцов защитным составом. Популярная длина 3,6 м и другие типоразмеры подходят для опалубки перекрытий, стен и колонн в монолитном строительстве.",
      "prod.norm.badge": "H20",
    ...
    en: {
      ...
      "index.procurement.kicker": "For construction and procurement",
      "index.procurement.title": "H20 formwork beams from the manufacturer",
      "index.procurement.lead": "Koros manufactures and supplies H20 beams for contractors, developers, rental fleets and procurement teams. We handle project-specific requests, tender documentation and recurring deliveries.",
      "index.procurement.benefits.title": "Advantages",
      "index.procurement.benefits.1": "200 mm I-beam geometry for slab, wall and column formwork systems.",
      "index.procurement.benefits.2": "Controlled timber, FSF plywood, PUR adhesive, moisture level and batch marking.",
      "index.procurement.benefits.3": "GOST R 71938-2025 and EN 13377:2002 compliance; documents available on request.",
      "index.procurement.delivery.title": "Delivery footprint",
      "index.procurement.delivery.text": "We ship BDK H20 beams from stock and production in the Leningrad Region. Delivery is arranged to Saint Petersburg, Vsevolozhsky, Gatchinsky, Kirovsky, Tosnensky, Lomonosovsky and other districts.",
      "index.procurement.apps.title": "Applications",
      "index.procurement.apps.text": "H20 beams are used in monolithic construction for slab decks, wall formwork, columns, pylons, elevator shafts and temporary load-bearing systems. Send a specification or bill of quantities so we can select length, volume and build.",
