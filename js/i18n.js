...
(function () {
  ...
  var STRINGS = {
    ru: {
      ...
      "index.hero.title.highlight": "балки БДК H20 для опалубки.",
      "index.hero.lead": "Более 10 лет опыта в деревопереработке. Объединяем лесопиление и выпуск фанеры с производством двутавровых балок для перекрытий и стен в монолитном строительстве — по российским и международным стандартам.",
      ...
      "index.product.title": "БДК H20: две линейки под ваши задачи",
      ...
      "index.specs.sub": "Для проектирования и снабжения",
      ...
      "cat.hero.title": "Линейки БДК H20",
      ...
      "compare.section.kicker": "Сравнение",
      "cat.card.norm.title": "БДК H20 Norm",
      "cat.card.norm.sub": "Линейка Norm",
      ...
      "cat.card.pro.title": "БДК H20 Pro",
      "cat.card.pro.sub": "Линейка Pro",
      ...
      "prod.hub.hero.lead": "Две линейки с общей геометрией и требованиями к прочности; отличаются полкой и защитой торцов. Выберите страницу исполнения или откройте сравнение в каталоге.",
      "prod.hub.compare.link": "Таблица сравнения Norm и Pro",
      ...
      "contact.form.title": "Запрос",
      "contact.form.name": "ФИО",
      "contact.form.company": "Компания",
      "contact.form.email": "Email",
      "contact.form.phone": "Телефон",
      "contact.form.materials": "Запрос по продукту",
      ...
      "contact.bento.compare.t": "Сравнение Norm / Pro",
      "contact.bento.compare.p": "Таблица различий по материалам и защите торцов.",
      "contact.bento.compare.link": "Сравнить",
      ...
      "compare.title": "Сравнение БДК H20 Norm и Pro",
      "compare.sub": "Одна высота и полка; отличаются толщина фанеры и тип защиты торцов.",
      "compare.th.param": "Параметр",
      "compare.th.norm": "БДК H20 Norm",
      "compare.th.pro": "БДК H20 Pro",
      "compare.r1.p": "Диапазон длин",
      "compare.r1.n": "От 1,5 до 6,0 м",
      "compare.r1.pr": "От 1,5 до 6,0 м",
      "compare.r2.p": "Древесина (хвоя)",
      "compare.r2.n": "1–2 сорт",
      "compare.r2.pr": "1–2 сорт",
      "compare.r3.p": "Полка (ширина × высота)",
      "compare.r3.n": "40×80 мм",
      "compare.r3.pr": "40×80 мм",
      "compare.r4.p": "Фанера",
      "compare.r4.n": "ФСФ 24 мм",
      "compare.r4.pr": "ФСФ 24 или 27 мм",
      "compare.r5.p": "Торцы",
      "compare.r5.n": "Обработка защитным составом",
      "compare.r5.pr": "Полимерные заглушки",
      "compare.r6.p": "Стандарты",
      "compare.r6.n": "ГОСТ Р 71938-2025, EN 13377:2002",
      "compare.r6.pr": "ГОСТ Р 71938-2025, EN 13377:2002",
      "compare.note": "Итоговый подбор длины, шага балок и нагрузок выполняется по проекту и нормам конкретной площадки.",
    ...
    en: {
      ...
      "index.hero.title.highlight": "H20 formwork timber beams.",
      "index.hero.lead": "Over 10 years in wood processing. We combine sawn timber and plywood production with I‑beam output for slabs and walls in monolithic construction — meeting Russian and international standards.",
      ...
      "index.product.title": "H20: two lines for your brief",
      ...
      "index.specs.sub": "For engineering and procurement",
      ...
      "cat.hero.title": "H20 product lines",
      "cat.hero.lead": "Pick the execution for your job: Norm for standard sites or Pro with polymer caps and up to 27 mm plywood.",
      "compare.section.kicker": "Comparison",

      "cat.card.norm.title": "H20 Norm",
      "cat.card.norm.sub": "Norm line",
      ...
      "prod.hub.hero.lead": "Two lines sharing the same geometry and strength requirements; they differ by flange build and end protection. Open the line you need or use the catalogue comparison.",
      "prod.hub.compare.link": "Norm vs Pro comparison table",
      ...
      "contact.form.materials": "Product focus",
      ...
      "contact.bento.compare.t": "Norm vs Pro",
      "contact.bento.compare.p": "Table of material and end-cap differences.",
      "contact.bento.compare.link": "Compare",
      ...
      "compare.title": "H20 Norm vs Pro",
      "compare.sub": "Same height and flange; plywood thickness and end protection differ.",
      "compare.th.param": "Parameter",
      "compare.th.norm": "H20 Norm",
      "compare.th.pro": "H20 Pro",
      "compare.r1.p": "Length range",
      "compare.r1.n": "1.5–6.0 m",
      "compare.r1.pr": "1.5–6.0 m",
      "compare.r2.p": "Softwood",
      "compare.r2.n": "Grades 1–2",
      "compare.r2.pr": "Grades 1–2",
      "compare.r3.p": "Flange (w×h)",
      "compare.r3.n": "40×80 mm",
      "compare.r3.pr": "40×80 mm",
      "compare.r4.p": "Plywood",
      "compare.r4.n": "FSF 24 mm",
      "compare.r4.pr": "FSF 24 or 27 mm",
      "compare.r5.p": "Beam ends",
      "compare.r5.n": "Protective compound",
      "compare.r5.pr": "Polymer caps",
      "compare.r6.p": "Standards",
      "compare.r6.n": "GOST R 71938-2025, EN 13377:2002",
      "compare.r6.pr": "GOST R 71938-2025, EN 13377:2002",
      "compare.note": "Final spacing, span and load checks belong to the project engineer and local codes.",
